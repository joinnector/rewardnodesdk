...
class LeadService extends base_sdk_service {
	...
	async get_by_customer_id(customer_id: string, swap_id: string = null as unknown as string): Promise<any> {
		return await super.get_by("customer_id", customer_id, swap_id);
	}
